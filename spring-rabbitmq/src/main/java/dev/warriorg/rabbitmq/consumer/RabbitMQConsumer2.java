    ...
    public void receiveMessage(String message) {
        ...
        try {
            Authentication authentication =
                    new UsernamePasswordAuthenticationToken("2-user-" + random.nextInt(100000), "ROLE_USER");
            ...
            if (logger.isDebugEnabled()) {
                logger.debug(Thread.currentThread().getName() + " | User: " + beforeName + " | Message: " + message);
            }
